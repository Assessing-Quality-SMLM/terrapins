...
class SquirrelInputsTests
{
    ...
    fun widefield_path()
    {
        ...
        assertEquals(settings.widefield_path_in(working_directory), expected)
    }
    ...
    fun widefield_changes_usage_on_filename_setting()
    {
        ...
        val settings = SquirrelInputs.default()
        settings.widefield().set_use_image(true)
        assertEquals(settings.widefield_path_in(working_directory), working_directory.resolve("widefield.tiff"))

        settings.set_widefield_filename("something.tiff")
        assertEquals(settings.widefield_path_in(working_directory), Paths.get("something.tiff"))
    }
    ...
    fun image_stack_path()
    {
        ...
        assertEquals(settings.image_stack_path_in(working_directory), expected)
    }
    ...
    fun image_stack_changes_usage_on_filename_setting()
    {
        ...
        assertEquals(settings.image_stack_path_in(working_directory), working_directory.resolve("image_stack.tiff"))

        settings.set_image_stack_filename("something.tiff")
        assertEquals(settings.image_stack_path_in(working_directory), Paths.get("something.tiff"))
    }
