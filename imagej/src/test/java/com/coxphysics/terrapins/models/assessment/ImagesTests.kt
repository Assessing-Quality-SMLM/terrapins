...
class ImagesTests
{
    ...
    fun default_arguments_test()
    {
        ...
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(), "--extract", "image", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
    ...
    fun can_use_reference_image()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(), "--extract", "image", "--reference-image", "some.thing", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_hawk_image()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--extract", "image", "--hawk-image", "some.thing", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_half_split()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--extract", "image", "--half-split-a", "some.thing", "--half-split-b", "some.thing.else", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_zip_split()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--extract", "image", "--zip-split-a", "some.thing", "--zip-split-b", "some.thing.else", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_widefield()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--widefield", "some.thing", "--extract", "image", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_image_stack()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--image-stack", "some.thing", "--extract", "image","--pixel-size-nm", "160.0",  "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
    ...
    fun can_use_settings_file()
    {
        ...
        val commands = Assessment.custom(exe_path()).get_images_arguments(settings)
        val expected = listOf(exe_path().toString(), "--working-directory", working_directory(),"--settings", "settings.file", "--extract", "image", "--pixel-size-nm", "160.0", "--psf-px", "270.0")
        assertArrayEquals(commands.toTypedArray(), expected.toTypedArray())
    }
}