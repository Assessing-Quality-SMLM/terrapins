...
import com.coxphysics.terrapins.vendored.thunderstorm.estimators.MFA_LSQFitter;
import com.coxphysics.terrapins.vendored.thunderstorm.estimators.MFA_MLEFitter;
...
public class CrowdedFieldEstimatorUI {
    ...
    public CrowdedFieldEstimatorUI() {
        params = new ParameterTracker("terrapins.thunderstorm.estimators.dense.mfa");
