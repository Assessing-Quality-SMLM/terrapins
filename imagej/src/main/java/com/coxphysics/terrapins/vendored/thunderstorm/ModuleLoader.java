...
import com.coxphysics.terrapins.vendored.thunderstorm.results.PostProcessingModule;
import ij.IJ;
...
public class ModuleLoader {
     ...
     * com.coxphysics.terrapins.vendored.thunderstorm.detectors.IDetector) and the content of the
