...
import com.coxphysics.terrapins.vendored.thunderstorm.util.MoleculeMatcher;
...
public class PerformanceEvaluationPlugIn implements PlugIn {
    ...
    class PerformanceEvaluationDialog extends DialogStub {
        ...
        public PerformanceEvaluationDialog() {
            super(new ParameterTracker("terrapins.thunderstorm.evaluation"), IJ.getInstance(), "ThunderSTORM: Performance evaluation");
