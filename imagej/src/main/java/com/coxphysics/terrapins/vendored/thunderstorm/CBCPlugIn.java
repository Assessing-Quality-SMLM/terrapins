...
import com.coxphysics.terrapins.vendored.thunderstorm.colocalization.CBC;
...
import com.coxphysics.terrapins.vendored.thunderstorm.rendering.ASHRendering;
import com.coxphysics.terrapins.vendored.thunderstorm.rendering.RenderingMethod;
import com.coxphysics.terrapins.vendored.thunderstorm.results.GenericTable;
import com.coxphysics.terrapins.vendored.thunderstorm.results.GenericTableModel;
...
import com.coxphysics.terrapins.vendored.thunderstorm.util.*;
...
public class CBCPlugIn implements PlugIn {
    ...
    class CBCDialog extends DialogStub {
        ...
        public CBCDialog(Window owner) {
            super(new ParameterTracker("terrapins.thunderstorm.cbc"), owner, "Coordinate-Based Colocalization");
