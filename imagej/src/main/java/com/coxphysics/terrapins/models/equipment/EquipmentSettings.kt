...
class EquipmentSettings private constructor(private var instrument_psf_fwmn_nm: Double, private var camera_pixel_size_nm: Double)
{
    companion object
    {
        fun default() : EquipmentSettings
        {
            return EquipmentSettings(270.0, 160.0)
        }
    }
